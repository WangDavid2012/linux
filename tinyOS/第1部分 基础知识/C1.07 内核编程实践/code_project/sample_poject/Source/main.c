...
/*****************************************************************
0xE000ED04 中断控制及状态寄存器，复位后，默认值是0x0
其中bit28 PENDSVSET 位，写1可以悬起pendsv，读取则返回pendsv的状态
bit27 PENDSVCLR  写1可以清除pendsv状态
此函数的功能: 给bit28 置位，软件方法触发pendsv中断，然后程序会自动跳转到
中断处理函数。
*******************************************************************/
